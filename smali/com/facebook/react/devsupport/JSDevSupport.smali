...
.method public declared-synchronized getJSHierarchy(ILcom/facebook/react/devsupport/JSDevSupport$DevSupportCallback;)V
    ...
    const-string v2, "JSDevSupport module not registered."

    invoke-direct {v1, v2}, Lcom/facebook/react/devsupport/JSCHeapCapture$CaptureException;-><init>(Ljava/lang/String;)V

    const/4 v2, 0x0

    invoke-interface {p2, v2, v1}, Lcom/facebook/react/devsupport/JSDevSupport$DevSupportCallback;->onFailure(ILjava/lang/Exception;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
