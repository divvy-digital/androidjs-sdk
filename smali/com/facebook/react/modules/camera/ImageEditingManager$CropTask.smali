...
.method private cropAndResize(IILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    iget v0, v1, Lcom/facebook/react/modules/camera/ImageEditingManager$CropTask;->mX:I

    int-to-float v14, v0

    .line 360
    .restart local v14    # "newX":F
    iget v0, v1, Lcom/facebook/react/modules/camera/ImageEditingManager$CropTask;->mY:I
    ...
    :goto_0
    invoke-static {v7, v9, v2, v3}, Lcom/facebook/react/modules/camera/ImageEditingManager;->access$600(IIII)I
    ...
    .line 390
    .local v24, "scaleMatrix":Landroid/graphics/Matrix;
    move-object/from16 v4, v24

    .end local v24    # "scaleMatrix":Landroid/graphics/Matrix;
    .local v4, "scaleMatrix":Landroid/graphics/Matrix;
    ...
    .end local v4    # "scaleMatrix":Landroid/graphics/Matrix;
...
.method protected varargs doInBackgroundGuarded([Ljava/lang/Void;)V
    ...
    invoke-direct {p0, v3, v5, v2}, Lcom/facebook/react/modules/camera/ImageEditingManager$CropTask;->cropAndResize(IILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;

    move-result-object v3

    .local v3, "cropped":Landroid/graphics/Bitmap;
    goto :goto_1

    .line 274
    .end local v3    # "cropped":Landroid/graphics/Bitmap;
    :cond_1
    ...
    .line 277
    .restart local v3    # "cropped":Landroid/graphics/Bitmap;
    :goto_1
    ...
    invoke-static {v3, v5, v6}, Lcom/facebook/react/modules/camera/ImageEditingManager;->access$400(Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/io/File;)V
    ...
    .restart local v3    # "cropped":Landroid/graphics/Bitmap;
    .restart local v4    # "hasTargetSize":Z
