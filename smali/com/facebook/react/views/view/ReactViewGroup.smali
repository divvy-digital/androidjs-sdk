...
.method private dispatchOverflowDraw(Landroid/graphics/Canvas;)V
    ...
    .line 744
    invoke-virtual {v15, v10, v4}, Lcom/facebook/react/views/view/ReactViewBackgroundDrawable;->getBorderRadiusOrDefaultTo(FLcom/facebook/react/views/view/ReactViewBackgroundDrawable$BorderRadiusLocation;)F

    move-result v4

    .line 747
    .local v4, "bottomRightBorderRadius":F
    nop

    .line 748
    iget v15, v0, Lcom/facebook/react/views/view/ReactViewGroup;->mLayoutDirection:I
    ...
    .line 750
    invoke-virtual {v5, v11}, Lcom/facebook/react/views/view/ReactViewBackgroundDrawable;->getBorderRadius(Lcom/facebook/react/views/view/ReactViewBackgroundDrawable$BorderRadiusLocation;)F

    move-result v5

    .line 752
    .local v5, "topStartBorderRadius":F
    ...
    .line 753
    invoke-virtual {v11, v8}, Lcom/facebook/react/views/view/ReactViewBackgroundDrawable;->getBorderRadius(Lcom/facebook/react/views/view/ReactViewBackgroundDrawable$BorderRadiusLocation;)F
    ...
    .line 756
    invoke-virtual {v11, v10}, Lcom/facebook/react/views/view/ReactViewBackgroundDrawable;->getBorderRadius(Lcom/facebook/react/views/view/ReactViewBackgroundDrawable$BorderRadiusLocation;)F
    ...
    .line 759
    invoke-virtual {v11, v1}, Lcom/facebook/react/views/view/ReactViewBackgroundDrawable;->getBorderRadius(Lcom/facebook/react/views/view/ReactViewBackgroundDrawable$BorderRadiusLocation;)F
    ...
    invoke-virtual {v11, v9}, Lcom/facebook/react/modules/i18nmanager/I18nUtil;->doLeftAndRightSwapInRTL(Landroid/content/Context;)Z
    ...
    .line 783
    .local v11, "directionAwareTopRightRadius":F
    :goto_4
    if-eqz v15, :cond_a
    ...
    .end local v11    # "directionAwareTopRightRadius":F
    ...
    .line 797
    .restart local v11    # "directionAwareTopRightRadius":F
    :goto_8
    if-eqz v15, :cond_f
    ...
    .end local v5    # "topStartBorderRadius":F
    .end local v8    # "topEndBorderRadius":F
    .end local v9    # "directionAwareTopLeftRadius":F
    .end local v10    # "bottomStartBorderRadius":F
    .end local v11    # "directionAwareTopRightRadius":F
    ...
    invoke-direct {v5, v2, v3, v6, v7}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    .line 829
    invoke-virtual {v1, v5, v8, v10}, Landroid/graphics/Path;->addRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/Path$Direction;)V
    ...
    .line 720
    .end local v4    # "bottomRightBorderRadius":F
    .end local v9    # "borderWidth":Landroid/graphics/RectF;
