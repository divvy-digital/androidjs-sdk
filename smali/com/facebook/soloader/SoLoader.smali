...
.method private static doLoadLibraryBySoName(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)V
    ...
    invoke-virtual {v14, v1, v2, v5}, Lcom/facebook/soloader/SoSource;->loadLibrary(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)I
    ...
    .line 687
    invoke-virtual {v4, v1, v2, v5}, Lcom/facebook/soloader/UnpackingSoSource;->loadLibrary(Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)I
...
.method private static initSoSources(Landroid/content/Context;ILcom/facebook/soloader/SoFileLoader;)V
    ...
    .line 222
    .local v7, "systemSoDirectory":Ljava/io/File;
    new-instance v8, Lcom/facebook/soloader/DirectorySoSource;

    const/4 v9, 0x2

    invoke-direct {v8, v7, v9}, Lcom/facebook/soloader/DirectorySoSource;-><init>(Ljava/io/File;I)V
    ...
    .end local v7    # "systemSoDirectory":Ljava/io/File;
    add-int/lit8 v6, v6, 0x1
    ...
    .line 238
    :try_start_1
    sput-object v9, Lcom/facebook/soloader/SoLoader;->sBackupSoSources:[Lcom/facebook/soloader/UnpackingSoSource;

    .line 239
    const-string v7, "adding exo package source: lib-main"

    invoke-static {v3, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 240
    new-instance v7, Lcom/facebook/soloader/ExoSoSource;

    invoke-direct {v7, v1, v8}, Lcom/facebook/soloader/ExoSoSource;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 272
    .local v9, "mainApkDir":Ljava/io/File;
    ...
    invoke-direct {v14, v1, v9, v8, v12}, Lcom/facebook/soloader/ApkSoSource;-><init>(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;I)V

    move-object v8, v14

    .line 275
    .local v8, "mainApkSource":Lcom/facebook/soloader/ApkSoSource;
    ...
    .local v7, "applicationInfo":Landroid/content/pm/ApplicationInfo;
    .restart local v14    # "splitIndex":I
    :cond_6
    move-object/from16 v16, v4
    ...
    .line 232
    .end local v8    # "mainApkSource":Lcom/facebook/soloader/ApkSoSource;
    .end local v9    # "mainApkDir":Ljava/io/File;
...
.method private static loadLibraryBySoName(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILandroid/os/StrictMode$ThreadPolicy;)Z
    ...
    .local v4, "loadingLibLock":Ljava/lang/Object;
    goto :goto_0

    .line 569
    .end local v4    # "loadingLibLock":Ljava/lang/Object;
    :cond_3
    ...
    .line 570
    .local v5, "loadingLibLock":Ljava/lang/Object;
    invoke-interface {v4, p0, v5}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-object v4, v5

    .line 572
    .end local v5    # "loadingLibLock":Ljava/lang/Object;
    .restart local v4    # "loadingLibLock":Ljava/lang/Object;
    :goto_0
    monitor-exit v2
    :try_end_0
    ...
    .line 597
    new-instance v3, Lcom/facebook/soloader/SoLoader$WrongAbiError;

    invoke-direct {v3, v1}, Lcom/facebook/soloader/SoLoader$WrongAbiError;-><init>(Ljava/lang/Throwable;)V
    ...
    const-string v5, "MergedSoMapping.invokeJniOnload["
...
.method public static prependSoSource(Lcom/facebook/soloader/SoSource;)V
    ...
    .line 801
    .local v3, "newSoSources":[Lcom/facebook/soloader/SoSource;
    const/4 v5, 0x0
    ...
    const-string v4, "Prepended to SO sources: "
    ...
    .end local v3    # "newSoSources":[Lcom/facebook/soloader/SoSource;
    invoke-virtual {v1}, Ljava/util/concurrent/locks/ReentrantReadWriteLock;->writeLock()Ljava/util/concurrent/locks/ReentrantReadWriteLock$WriteLock;
